...
class AfterBrush extends StatefulWidget {
  final int age;
  const AfterBrush({Key? key, this.age=0}) : super(key: key);

  @override
  State<AfterBrush> createState() => _AfterBrushState();
}
            ...
            Padding(
              ...
              child: Container(
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                      color: Color.fromARGB(255, 149, 149, 149).withOpacity(0.5),
              spreadRadius: 1.0,
              blurRadius: 8.0,
