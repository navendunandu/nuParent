                    ...
                    Row(
                      ...
                      children: [
                        const Column(
                          ...
                          children: [
                            Text('Your Child’s', style:
                                          TextStyle(color: AppColors.darkblue, fontWeight: FontWeight.w500, fontSize: 20),),
                                          Text('Dietary Intake',style:
                                          TextStyle(color: AppColors.darkblue, fontWeight: FontWeight.w500, fontSize: 20),),
                          ],
                        ),
                        Image.asset('assets/Eating.png', width: 200,),
                      ],
                    ),
                    const SizedBox(
                      height: 20,
